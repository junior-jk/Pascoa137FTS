...
public class eveClassLogin {
    ...
    public void testeLogin() {
        ...
        driver.findElement(By.cssSelector("input[type=\"email\"]")).sendKeys("henrryjk@hotmail.com.br");
        driver.findElement(By.cssSelector("input[type=\"password\"]")).sendKeys("963452");
