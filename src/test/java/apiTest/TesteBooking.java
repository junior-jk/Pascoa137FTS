...
public class TesteBooking {
    ...
    public void testeCreateToken() throws IOException {
        ...
        String jsonBody = lerArquivoJson ("src/test/resources/json/boonkingAuth.json");
    ...
    public void testeCreateBooking() throws IOException {
        ...
        .then()
                .log().all()
                .statusCode(200)
                .body("booking.firstname", is("Jota"))
                .body("booking.lastname", is("Ele"))
                .extract();
    ...
    public void testeGetBooking() {
        ...
        .then()
                .log().all()
                .statusCode(200)
                .body("firstname", is("Jota"))
                .body("lastname", is("Ele"));
    }
